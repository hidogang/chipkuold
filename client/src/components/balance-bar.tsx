  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      <Card className="p-4">
        ...
        <p className="text-2xl font-bold">{resourcesQuery.data?.waterBuckets || 0}</p>
      </Card>
      ...
      <Card className="p-4">
        ...
        <p className="text-2xl font-bold">{resourcesQuery.data?.wheatBags || 0}</p>
      </Card>
      ...
      <Card className="p-4">
        ...
        <p className="text-2xl font-bold">{resourcesQuery.data?.eggs || 0}</p>
      </Card>
      ...
      <Card className="p-4">
        ...
        <p className="text-2xl font-bold">${user.usdtBalance}</p>
      </Card>
    </div>
  );
}